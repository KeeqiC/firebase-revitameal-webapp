      ...
      <div className="h-full bg-[#F27F34] shadow-lg w-64 flex flex-col py-6 space-y-8">
        ...
        <div className="flex justify-between items-center px-4 mb-6">
          ...
          <button
            ...
            className="p-2 rounded-lg hover:bg-white/20 transition-colors md:hidden" // Tombol tutup hanya tampil di mobile
          >
        ...
        <div className="mt-auto px-4 space-y-2">
          ...
          <button
            onClick={toggleSidebar} // Logic untuk logout akan ditambahkan nanti
